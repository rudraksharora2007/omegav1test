  ...
  options: [ 
    ...
    try {    
      if(user) {
        ...
        let button_support_dc = new MessageButton().setStyle('LINK').setLabel(handlemsg(client.la[ls].cmds.info.invite.buttons.server)).setURL("https://discord.gg/OmegaV2")
        ...
        interaction.reply({ephemeral: true, 
          embeds: [new MessageEmbed()
            ...
            .setFooter(client.getFooter(`${user.username} | powered by OmegaV2.dev`, "https://imgur.com/jPItIw0.gif"))],
        ...
        interaction.reply({ephemeral: true, 
          embeds: [new MessageEmbed()
            ...
            .setFooter(`${client.user.username} | powered by OmegaV2.dev`, "https://imgur.com/jPItIw0.gif")],
          components: allbuttons
        });
      }
    } catch (e) {
